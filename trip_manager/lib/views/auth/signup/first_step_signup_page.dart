...
class FirstStepSignupPage extends ConsumerWidget {
  const FirstStepSignupPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final checkBoxState = ref.watch(firstStepSignupProvider);
    final isAllAccepted =
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TermsOfUseCheckBox(
                          contents: '(필수) 이용약관',
                          toggleCallback: ref
                              .read(firstStepSignupProvider.notifier)
                              .toggleTerms,
